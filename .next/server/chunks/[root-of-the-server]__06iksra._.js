module.exports=[18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},24361,(e,t,r)=>{t.exports=e.x("util",()=>require("util"))},14747,(e,t,r)=>{t.exports=e.x("path",()=>require("path"))},3848,55038,96547,e=>{"use strict";e.i(59661),e.i(30219),e.i(81619),e.i(37730),e.i(52766);var t=e.i(82087);function r(e){let t=[];try{e.SKILLS&&(t="string"==typeof e.SKILLS?JSON.parse(e.SKILLS):Array.isArray(e.SKILLS)?e.SKILLS:[])}catch{t=[]}let r=(e.ROLE||e.role||"").toLowerCase(),a="Caregivers";return r.includes("nurse")||"nursing"===r?a="Nurses":r.includes("doctor")||r.includes("physician")||r.includes("specialist")?a="Doctors":r.includes("physiotherapist")||r.includes("physio")?a="Physiotherapists":t.some(e=>e.toLowerCase().includes("icu")||e.toLowerCase().includes("nurs"))&&(a="Nurses"),{id:e.STAFF_ID||e.staff_id,agencyId:e.AGENCY_ID||e.agency_id,fullName:e.FULL_NAME||e.full_name,email:e.EMAIL||e.email,phone:e.PHONE_NUMBER||e.phone_number||e.phone,avatarUrl:e.AVATAR_URL||e.avatar_url||"https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150",category:a,role:e.ROLE||e.role||"Caregiver",organization:e.AGENCY_NAME||e.agency_name||"HomeCare Partner",rating:Number(e.RATING||e.rating||5),experienceYears:Number(e.EXPERIENCE_YEARS||e.experience_years||2),status:e.STATUS||e.status||"active",skills:t}}e.i(77592),e.i(40376),e.i(7682),e.i(6203),e.i(43211),e.i(74736),e.s(["ProfessionalRepository",0,{async getAll(){let e=`
    ...
    `;return await (0,a.executeQuery)(t),(await (0,a.executeQuery)("SELECT * FROM CORE.NOTIFICATIONS WHERE user_id = ? ORDER BY created_at DESC;",[e])).map(e=>({id:e.ID||e.id,userId:e.USER_ID||e.user_id,title:e.TITLE||e.title,message:e.MESSAGE||e.message,status:e.STATUS||e.status,retries:Number(e.RETRIES||e.retries||0),createdAt:e.CREATED_AT||e.created_at}))}}],65051),e.i(6203),e.i(85527),e.i(40376),e.i(43211),e.i(62591),e.s([],28228)},98325,e=>{"use strict";var t=e.i(47909),r=e.i(74017),a=e.i(96250),s=e.i(59756),i=e.i(61916),n=e.i(74677),o=e.i(19163),E=e.i(16795),l=e.i(87718),u=e.i(95169),A=e.i(47587),p=e.i(66012),R=e.i(70101),I=e.i(26937),d=e.i(10372),c=e.i(93695);e.i(52474);var T=e.i(220),N=e.i(89171);e.i(3848);var S=e.i(30219),O=e.i(77592);e.i(28228);var _=e.i(65051);async function C(e,{params:t}){try{let{id:r}=await t,{status:a,remarks:s}=await e.json();if(!a)return N.NextResponse.json({success:!1,error:"Verification status is required"},{status:400});let i=await S.AgencyRepository.findById(r);if(!i)return N.NextResponse.json({success:!1,error:"Agency not found"},{status:404});let n=await S.AgencyRepository.update(r,{status:a,verified:"approved"===a});await O.AuditRepository.createLog("Platform Admin","Agency Verification Complete",`Agency"${i.name}" verification decision set to ${a.toUpperCase()}. Comments: ${s||"None"}`,e.headers.get("x-forwarded-for")||"127.0.0.1");let o="approved"===a?"Congratulations! Your Agency is Live":"Action Required: Verification status update";return await _.NotificationService.sendNotification({userId:i.email,title:o,template:"Your Home Healthcare Agency profile has been marked as {{status}}. Details: {{remarks}}",variables:{status:a,remarks:s||"Welcome to the HomeCare Marketplace!"}}),N.NextResponse.json({success:!0,agency:n})}catch(e){return N.NextResponse.json({success:!1,error:e.message},{status:500})}}e.s(["POST",0,C],21994);var L=e.i(21994);let h=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/admin/agencies/[id]/verify/route",pathname:"/api/admin/agencies/[id]/verify",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/admin/agencies/[id]/verify/route.ts",nextConfigOutput:"",userland:L,...{}}),{workAsyncStorage:P,workUnitAsyncStorage:m,serverHooks:y}=h;async function v(e,t,a){a.requestMeta&&(0,s.setRequestMeta)(e,a.requestMeta),h.isDev&&(0,s.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let N="/api/admin/agencies/[id]/verify/route";N=N.replace(/\/index$/,"")||"/";let S=await h.prepare(e,t,{srcPage:N,multiZoneDraftMode:!1});if(!S)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:O,deploymentId:_,params:C,nextConfig:L,parsedUrl:P,isDraftMode:m,prerenderManifest:y,routerServerContext:v,isOnDemandRevalidate:f,revalidateOnlyGenerated:g,resolvedPathname:x,clientReferenceManifest:M,serverActionsManifest:D}=S,F=(0,o.normalizeAppPath)(N),w=!!(y.dynamicRoutes[F]||y.routes[x]),U=async()=>((null==v?void 0:v.render404)?await v.render404(e,t,P,!1):t.end("This page could not be found"),null);if(w&&!m){let e=!!y.routes[x],t=y.dynamicRoutes[F];if(t&&!1===t.fallback&&!e){if(L.adapterPath)return await U();throw new c.NoFallbackError}}let H=null;!w||h.isDev||m||(H="/index"===(H=x)?"/":H);let Y=!0===h.isDev||!w,b=w&&!Y;D&&M&&(0,n.setManifestsSingleton)({page:N,clientReferenceManifest:M,serverActionsManifest:D});let G=e.method||"GET",q=(0,i.getTracer)(),V=q.getActiveScopeSpan(),j=!!(null==v?void 0:v.isWrappedByNextServer),k=!!(0,s.getRequestMeta)(e,"minimalMode"),B=(0,s.getRequestMeta)(e,"incrementalCache")||await h.getIncrementalCache(e,L,y,k);null==B||B.resetRequestCache(),globalThis.__incrementalCache=B;let K={params:C,previewProps:y.preview,renderOpts:{experimental:{authInterrupts:!!L.experimental.authInterrupts},cacheComponents:!!L.cacheComponents,supportsDynamicResponse:Y,incrementalCache:B,cacheLifeProfiles:L.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,a,s)=>h.onRequestError(e,t,a,s,v)},sharedContext:{buildId:O,deploymentId:_}},Z=new E.NodeNextRequest(e),$=new E.NodeNextResponse(t),Q=l.NextRequestAdapter.fromNodeNextRequest(Z,(0,l.signalFromNodeResponse)(t));try{let s,n=async e=>h.handle(Q,K).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=q.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==u.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=r.get("next.route");if(a){let t=`${G} ${a}`;e.setAttributes({"next.route":a,"http.route":a,"next.span_name":t}),e.updateName(t),s&&s!==e&&(s.setAttribute("http.route",a),s.updateName(t))}else e.updateName(`${G} ${N}`)}),o=async s=>{var i,o;let E=async({previousCacheEntry:r})=>{try{if(!k&&f&&g&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let i=await n(s);e.fetchMetrics=K.renderOpts.fetchMetrics;let o=K.renderOpts.pendingWaitUntil;o&&a.waitUntil&&(a.waitUntil(o),o=void 0);let E=K.renderOpts.collectedTags;if(!w)return await (0,p.sendResponse)(Z,$,i,K.renderOpts.pendingWaitUntil),null;{let e=await i.blob(),t=(0,R.toNodeOutgoingHttpHeaders)(i.headers);E&&(t[d.NEXT_CACHE_TAGS_HEADER]=E),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==K.renderOpts.collectedRevalidate&&!(K.renderOpts.collectedRevalidate>=d.INFINITE_CACHE)&&K.renderOpts.collectedRevalidate,a=void 0===K.renderOpts.collectedExpire||K.renderOpts.collectedExpire>=d.INFINITE_CACHE?void 0:K.renderOpts.collectedExpire;return{value:{kind:T.CachedRouteKind.APP_ROUTE,status:i.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:a}}}}catch(t){throw(null==r?void 0:r.isStale)&&await h.onRequestError(e,t,{routerKind:"App Router",routePath:N,routeType:"route",revalidateReason:(0,A.getRevalidateReason)({isStaticGeneration:b,isOnDemandRevalidate:f})},!1,v),t}},l=await h.handleResponse({req:e,nextConfig:L,cacheKey:H,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:y,isRoutePPREnabled:!1,isOnDemandRevalidate:f,revalidateOnlyGenerated:g,responseGenerator:E,waitUntil:a.waitUntil,isMinimalMode:k});if(!w)return null;if((null==l||null==(i=l.value)?void 0:i.kind)!==T.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==l||null==(o=l.value)?void 0:o.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});k||t.setHeader("x-nextjs-cache",f?"REVALIDATED":l.isMiss?"MISS":l.isStale?"STALE":"HIT"),m&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let u=(0,R.fromNodeOutgoingHttpHeaders)(l.value.headers);return k&&w||u.delete(d.NEXT_CACHE_TAGS_HEADER),!l.cacheControl||t.getHeader("Cache-Control")||u.get("Cache-Control")||u.set("Cache-Control",(0,I.getCacheControlHeader)(l.cacheControl)),await (0,p.sendResponse)(Z,$,new Response(l.value.body,{headers:u,status:l.value.status||200})),null};j&&V?await o(V):(s=q.getActiveScopeSpan(),await q.withPropagatedContext(e.headers,()=>q.trace(u.BaseServerSpan.handleRequest,{spanName:`${G} ${N}`,kind:i.SpanKind.SERVER,attributes:{"http.method":G,"http.target":e.url}},o),void 0,!j))}catch(t){if(t instanceof c.NoFallbackError||await h.onRequestError(e,t,{routerKind:"App Router",routePath:F,routeType:"route",revalidateReason:(0,A.getRevalidateReason)({isStaticGeneration:b,isOnDemandRevalidate:f})},!1,v),w)throw t;return await (0,p.sendResponse)(Z,$,new Response(null,{status:500})),null}}e.s(["handler",0,v,"patchFetch",0,function(){return(0,a.patchFetch)({workAsyncStorage:P,workUnitAsyncStorage:m})},"routeModule",0,h,"serverHooks",0,y,"workAsyncStorage",0,P,"workUnitAsyncStorage",0,m],98325)},85685,e=>{e.v(e=>Promise.resolve().then(()=>e(54799)))},91961,e=>{e.v(t=>Promise.all(["server/chunks/[root-of-the-server]__20ne-ty._.js"].map(t=>e.l(t))).then(()=>t(12111)))},72331,e=>{e.v(t=>Promise.all(["server/chunks/[root-of-the-server]__0k55_h7._.js","server/chunks/[root-of-the-server]__1k5x3fc._.js","server/chunks/[root-of-the-server]__0sdbg-b._.js"].map(t=>e.l(t))).then(()=>t(20442)))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__06iksra._.js.map